...
var _producsService = require("./js/producs-service");
var _header = require("./js/header");
var _product = require("./js/product");
(0, _producsService.initApplicationData)();

},{"./js/producs-service":"hla8O","./js/header":"bvS82","./js/product":"5J9JY"}],"hla8O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getProducts", ()=>(0, _localStorageService.getProducts));
parcelHelpers.export(exports, "getCategories", ()=>(0, _localStorageService.getCategories));
parcelHelpers.export(exports, "initApplicationData", ()=>initApplicationData);
var _localStorageService = require("./local-storage-service");
var _productConstants = require("./product-constants");
function initApplicationData() {
    if ((0, _localStorageService.getCategories)().length && (0, _localStorageService.getProducts)().length) return;
    (0, _localStorageService.saveProducts)((0, _productConstants.PRODUCTS));
    (0, _localStorageService.saveCategories)((0, _productConstants.CATEGORIES));
}

},{"./local-storage-service":"3Gm7A","./product-constants":"fhFA2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Gm7A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "saveCategories", ()=>saveCategories);
...
},{}],"fhFA2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _sessionStorageService = require("./session-storage-service");
var _cartService = require("./cart-service");
function renderCartCount() {
    const cartCount = (0, _cartService.getCartCount)();
    const cartCountElement = document.querySelector("#cart-count");
    cartCountElement.textContent = cartCount ? cartCount : "";
}
renderCartCount();
document.addEventListener((0, _sessionStorageService.CART_UPDATED_EVENT), renderCartCount);

},{"./session-storage-service":"g2AEZ","./cart-service":"iinBt"}],"g2AEZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "CART_UPDATED_EVENT", ()=>CART_UPDATED_EVENT);
const CART_KEY = "cart";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iinBt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addToCart", ()=>addToCart);
parcelHelpers.export(exports, "setAmount", ()=>setAmount);
parcelHelpers.export(exports, "clearCart", ()=>clearCart);
parcelHelpers.export(exports, "getCartCount", ()=>getCartCount);
parcelHelpers.export(exports, "removeFromCart", ()=>removeFromCart);
var _sessionStorageService = require("./session-storage-service");
function getCartCount() {
    const cart = (0, _sessionStorageService.getCart)();
    return Object.values(cart).reduce((acc, count)=>acc + count, 0);
}
function addToCart(id) {
    const cart = (0, _sessionStorageService.getCart)();
    cart[id] = cart[id] ? cart[id] + 1 : 1;
    (0, _sessionStorageService.saveCart)(cart);
}
...
function clearCart() {
    (0, _sessionStorageService.removeCart)();
}

},{"./session-storage-service":"g2AEZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5J9JY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showProductModal", ()=>showProductModal);
parcelHelpers.export(exports, "hideProductModal", ()=>hideProductModal);
var _producsService = require("./producs-service");
var _cartService = require("./cart-service");
...
function showProductModal(id) {
    const products = (0, _producsService.getProducts)();
...
function renderProduct(product2) {
    const { id , name , img , price , description , categoryId  } = product2;
...
refs.modalContainer.addEventListener("click", (event)=>{
    if (event.target.classList.contains("js-add-amount-to-cart")) {
        ...
        (0, _cartService.setAmount)(productId, amount);
        (0, _notiflix.Notify).success(amount === 1 ? "\u0422\u043E\u0432\u0430\u0440 \u0434\u043E\u0434\u0430\u043D\u043E \u0432 \u043A\u043E\u0448\u0438\u043A" : "\u0422\u043E\u0432\u0430\u0440\u0438 \u0434\u043E\u0434\u0430\u043D\u043E \u0432 \u043A\u043E\u0448\u0438\u043A");
        hideProductModal();
...
document.addEventListener("keydown", (event)=>{
    if (event.code === "Escape") hideProductModal();
});
refs.modal.addEventListener("click", (event)=>{
    if (event.target === event.currentTarget) hideProductModal();
});

},{"./producs-service":"hla8O","./cart-service":"iinBt","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=delivery.975ef6c8.js.map

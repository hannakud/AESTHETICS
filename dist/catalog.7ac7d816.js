...
})({"clgWE":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "9b4cf4177ac7d816";
...
},{}],"jQAFG":[function(require,module,exports) {
...
renderProducts();
refs.catalogList.addEventListener("click", (event)=>{
    if (event.target.classList.contains("js-add-to-cart")) {
        event.preventDefault();
        (0, _cartService.addToCart)(event.target.dataset.id);
        (0, _notiflix.Notify).success("\u0422\u043E\u0432\u0430\u0440 \u0434\u043E\u0434\u0430\u043D\u043E \u0432 \u043A\u043E\u0448\u0438\u043A");
    } else if (event.target.classList.contains("js-view-details")) {
        event.preventDefault();
        const productId = Number(event.target.dataset.id);
        (0, _product.showProductModal)(productId);
    }
}, true);

},{"notiflix":"5z0Oc","./cart-service":"iinBt","./producs-service":"hla8O","./product":"5J9JY"}]},["clgWE","jQAFG"], "jQAFG", "parcelRequired7c6")

//# sourceMappingURL=catalog.7ac7d816.js.map
